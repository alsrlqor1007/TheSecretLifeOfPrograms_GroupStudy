...
『한 권으로 읽는 컴퓨터 구조와 프로그래밍(The Secret Life Of Programs)』으로 진행하는 Computer Science 그룹 북 스터디 레포지토리입니다. 매주 한 챕터씩 읽고 각자 담당 파트를 정리해 주 1회 토론으로 지식 공유와 의견 교류를 통해 이해도를 높이고 있습니다.
